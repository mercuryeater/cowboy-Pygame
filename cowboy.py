...
instructions = [
    ...
    "No dejes que te toque la planta rodadora"
]

text_instructions = [instructions_font.render(instruction, False, "#8c3918") for instruction in instructions]
    ...
    while running:
        ...
        if pause == True:
            ...
            for tumbleweed in enemy_group:
                bullets_hit = pygame.sprite.spritecollide(
                    tumbleweed, bullet_group, True
                )
...
def info():
    ...
    while True:
        ...
        for i, instruction in enumerate(text_instructions):
            screen.blit(instruction, (50, 190 + i*70))

        OPTIONS_BACK = Button(image=None, pos=(SCREEN_WIDTH/2, 560), 
                            text_input="BACK", font=menu_font, base_color="#eba894", hovering_color="white")
